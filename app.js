const DATA = [
  {
    ...
    "stages": [
      ...
      {
        "title": "決勝戦 香盤",
        "note": "送付いただいたNOROSHI2026決勝戦の香盤表をもとに追加。",
        "entries": [
          [
            "1",
            "ドクター覚張",
  ...
  },
  {
    ...
    "runnerUp": "ノットリリースザボール",
    "runnerSchool": "筑波大学お笑い集団DONPAPA",
    "third": "宮尾皇駕",
    "thirdSchool": "早稲田大学お笑い工房LUDO/早稲田大学お笑い集団POP3",
    "judge": "—",
    "judgeSchool": "",
    "stages": [
      {
        "title": "決勝結果",
        "note": "ユーザー提供の結果情報をもとに追加。",
        "entries": [
          [
            "優勝",
            "妖怪しば犬",
      ...
      {
        "title": "決勝戦 香盤",
        "note": "送付いただいた学生お笑い新人戦2026決勝戦の香盤表をもとに追加。順位結果は未登録。",
        "entries": [
          [
            "1",
            "ジョーリンジ",
  ...
  },
  {
    ...
    "stages": [
      ...
      {
        "title": "決勝戦 香盤",
        "note": "送付いただいたNOROSHI2025決勝戦の香盤表をもとに追加。",
        "entries": [
          [
            "1",
            "チームタクシーで行く",
  ...
  },
  {
    ...
    "event": "学生お笑い新人戦 2025",
    "winner": "西っち14",
    "school": "近畿大学お笑いサークルこども帝国",
    "runnerUp": "ソフト派",
    "runnerSchool": "明治大学お笑いサークル木曜会Z",
    "third": "スマートな着地",
    "thirdSchool": "青山学院大学ナショグルお笑い愛好会",
    "judge": "—",
    "judgeSchool": "",
    "stages": [
      {
      ...
      {
        "title": "決勝戦 香盤",
        "note": "送付いただいた学生お笑い新人戦2025決勝戦の香盤表をもとに追加。順位結果は未登録。",
        "entries": [
          [
            "1",
            "暴飲サルサジコ",
  ...
  },
  {
    ...
    "stages": [
      ...
      {
        "title": "決勝戦 香盤",
        "note": "送付いただいたNOROSHI2024決勝戦の香盤表をもとに追加。",
        "entries": [
          [
            "1",
            "チームガガガ",
  ...
  },
  {
    ...
    "stages": [
      ...
      {
        "title": "決勝戦 香盤",
        "note": "送付いただいた学生お笑い新人戦2024決勝戦の香盤表をもとに追加。順位結果は未登録。",
        "entries": [
          [
            "1",
            "さかなの乱",
  ...
  },
  {
    ...
    "stages": [
      ...
      {
        "title": "決勝戦 香盤",
        "note": "送付いただいたNOROSHI2023決勝戦の香盤表をもとに追加。",
        "entries": [
          [
            "1",
            "チーム新都心",
  ...
  },
  {
    ...
    "stages": [
      ...
      {
        "title": "決勝戦 香盤",
        "note": "送付いただいた学生お笑い新人戦2023決勝戦の香盤表をもとに追加。順位結果は未登録。",
        "entries": [
          [
            "1",
            "凸撃隊",
    ...
    "fourth": "赤ビーム",
    "fourthSchool": "慶應義塾大学お笑い道場O-keis"
  },
  {
    "year": 2023,
    "type": "individual",
  ...
  },
  {
    ...
    "stages": [
      ...
      {
        "title": "決勝戦 香盤",
        "note": "送付いただいたNOROSHI2022決勝戦の香盤表をもとに追加。",
        "entries": [
          [
            "1",
            "チーム月旅行",
  ...
  },
  {
    ...
    "stages": [
      ...
      {
        "title": "決勝戦 香盤",
        "note": "送付いただいた学生お笑い新人戦2022決勝戦の香盤表をもとに追加。順位結果は未登録。",
        "entries": [
          [
            "1",
            "月蝕",
...
function displayEvents(items){
  // Site display: newest first.
  // Within the same year: 学生R-1 → 大学芸会 → 新人戦 → NOROSHI
  const order={r1:0,individual:1,"old-team":1,newcomer:2,noroshi:3};
...
// 大会結果一覧は新しい年度から古い年度へ。
// 同一年は上から：学生R-1 → 大学芸会 → 学生お笑い新人戦 → NOROSHI → 旧団体戦
const EVENT_DISPLAY_ORDER={r1:0,individual:1,newcomer:2,noroshi:3,"old-team":4};
...
function unitsHTML(units=[]){
  ...
  return `<div class="unit-composition">${units.map(u=>{
    let genre="", name="";
    if(typeof u==="string"){
      name=u;
    ...
    if(!name) return "";
    return `<span class="unit-chip">${genre?`<em>${genre}</em>`:""}${unitLink(name)}</span>`;
  }).join("")}</div>`;
}
...
// 最新結果も同じ表示順を強制
const latest = sortEventsForDisplay(displayEvents(DATA).filter(d=>d.winner!=="開催中止")).slice(0,3);
...
function render(){
  ...
  const filtered=sortEventsForDisplay(displayEvents(DATA).filter(d=>
